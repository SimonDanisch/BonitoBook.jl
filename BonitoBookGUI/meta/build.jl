...
target_name = "bonitobookgui-$version-$(target_arch)"
...
if :macos in target_platforms
    AppBundler.build_app(MacOS(target_arch), APP_DIR, "$build_dir/$target_name"; precompile, incremental, adhoc_signing)
