...
For module-based plugins, pass the module directly:

```julia
create_book("my-plugin.md"; plugin=BonitoBook.LLMChatBooks, theme="dark")
book("my-plugin.md"; plugin=BonitoBook.LLMChatBooks, theme="dark")
```
